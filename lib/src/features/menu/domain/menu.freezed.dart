...
abstract class $MenuCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, List<Food> foods});
}
...
class _$_Menu with DiagnosticableTreeMixin implements _Menu {
  const _$_Menu({required this.id, required final List<Food> foods})
      : _foods = foods;
...
abstract class _Menu implements Menu {
  const factory _Menu(
      {required final String id, required final List<Food> foods}) = _$_Menu;

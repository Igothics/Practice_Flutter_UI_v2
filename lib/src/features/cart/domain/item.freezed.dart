...
abstract class $ItemCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? id, bool activated, Order order});
...
class _$ItemImpl with DiagnosticableTreeMixin implements _Item {
  const _$ItemImpl({this.id, this.activated = true, required this.order});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Item(id: $id, activated: $activated, order: $order)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, activated, order);
...
abstract class _Item implements Item {
  const factory _Item(
      {final int? id,
      final bool activated,
      required final Order order}) = _$ItemImpl;
